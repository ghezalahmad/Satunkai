...
export const translations: Translations = {
    en: {
        ...
        complianceDesc: 'Save videos for offline viewing. Some platforms may temporarily block downloads. Use "Open in App" as an alternative.',
        adLoading: 'Loading...',
    ...
    da: {
        ...
        complianceDesc: 'ویدیوها را برای مشاهده آفلاین ذخیره کنید. برخی پلتفرم‌ها ممکن است دانلود را موقتاً مسدود کنند. از "باز کردن در برنامه" استفاده کنید.',
    ...
    ps: {
        ...
        complianceDesc: 'ویډیوګانې د آفلاین لیدلو لپاره خوندي کړئ. ځینې پلیټفارمونه ممکن ډانلوډ بندوي. د بدیل په توګه "په اپ کې پرانیزئ" وکاروئ.',
